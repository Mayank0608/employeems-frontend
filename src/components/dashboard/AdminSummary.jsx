...
const AdminSummary = () => {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try{
        const summary = await axios.get('https://employeems-api.onrender.com/api/dashboard/summary', {
          headers : {
  ...
  return (
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
        <SummaryCard icon={<FaUser />} text="Total Employees" number={summary.totalEmployees} color="bg-gray-800" />
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <SummaryCard icon={<FaCheckCircle />} text="Leave Approved " number={summary.leaveSummary.approved} color="bg-gray-600" />
