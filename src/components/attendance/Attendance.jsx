...
const Attendance = () => {
    ...
    const fetchAttendance = async () => {
      setLoading(true)
    try {
      const response = await axios.get('https://employeems-api.onrender.com/api/attendance', {
        headers: {
    ...
    return (
        <div className="p-6">
            ...
            <div className='flex justify-between items-center mt-4'>
                ...
                <Link to="/admin-dashboard/attendance-report" className="px-4 py-1 bg-teal-700 rounded text-white">Attendance Report  </Link>
            </div>
            <div className="mt-6">
